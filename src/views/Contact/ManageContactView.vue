        ...
        <div v-if="state.formShown">
          ...
          <div>
            ...
            <div class="field grid">
              <label for="businessName" class="col-12 mb-2 md:col-2 md:mb-0"> Business Name </label>
            ...
            <div class="field grid">
              ...
              <div class="col-12 md:col-10">
                <InputText id="companyId" v-model="state.selection.data.companyId" class="w-full" />
              </div>
            </div>
            <div class="field grid">
            ...
            <div class="field grid">
              ...
              <div class="col-12 md:col-10">
                <InputText id="firstName" v-model="state.selection.data.firstName" class="w-full" />
              </div>
            </div>
            <div class="field grid">
              <label for="lastName" class="col-12 mb-2 md:col-2 md:mb-0"> Contact last name </label>
              <div class="col-12 md:col-10">
                <InputText id="lastName" v-model="state.selection.data.lastName" class="w-full" />
              </div>
            </div>
            <div class="field grid">
            ...
            <div class="field grid">
              <label for="signatureUrl" class="col-12 mb-2 md:col-2 md:mb-0"> Signature Url </label>
              <div class="col-12 md:col-10">
                <InputText
                  id="signatureUrl"
            ...
            <div class="field grid">
              ...
              <div class="col-12 md:col-10">
                <Button v-if="state.selection.id" @click="editItem" :disabled="state.processing">
                  Edit
                </Button>
                <Button
                ...
                <Button v-if="!state.selection.id" @click="createItem" :disabled="state.processing">
                  Create
                </Button>
              </div>
            </div>
            ...
            <div class="grid" v-if="state.filters['global']">
              <div class="col">
                <span class="p-input-icon-left">
                  ...
                  <InputText v-model="state.filters['global'].value" placeholder="Keyword Search" />
                </span>
              </div>
