export const InvoiceService = {
  ...
  getInvoicesMini() {
    return Promise.resolve(this.getInvoicesData().slice(0, 5))
  },

  getInvoicesSmall() {
    return Promise.resolve(this.getInvoicesData().slice(0, 10))
  },
  ...
  getInvoicesWithOrdersSmall() {
    return Promise.resolve(this.getInvoicesWithOrdersData().slice(0, 10))
  },

  getInvoicesWithOrders() {
    return Promise.resolve(this.getInvoicesWithOrdersData())
  }
}
